    ...
    def __init__(self, scale=1., dv_hys=0.0, chem=0, scale_cap=1.,s_cap_chg=1., s_cap_dis=1., s_hys_chg=1., s_hys_dis=1.,
        ...
        if t_soc1 is None:
            ...
            if myCH_Tuner == 1:  # same as BB but scale s_hys and s_hys_cap in run, and t_dv_min = 0
                ...
                t_dv1 = [-0.3, -0.1,    -.05,  -.04,  0.0,  0.06,  0.07,  0.1,   0.3]
                schp8 = [0.004, 0.004,  0.004,  0.4,  0.4,  0.4,   0.010, 0.008, 0.008]
                schp9 = [0.003, 0.003,  0.003,  0.4,  0.4,  0.003, 0.003, 0.003, 0.003]
                schp95 = [0.03,  0.03,  0.03,   0.4,  0.4,  0.08,  0.08,  0.08,  0.08]
