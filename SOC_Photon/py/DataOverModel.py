...
def overall(mo, mv, so, sv, smv, filename, fig_files=None, plot_title=None, n_fig=None):
    ...
    if so and smv:
        ...
        plt.plot(mv.time, mv.dv_hys, marker='.', markersize='1', markevery=35, linestyle='None', color='cyan', label='e_wrap_ver')
        plt.plot(mo.time, mo.dV_hys, linestyle='-.', color='orange', label='dV_hys')
        plt.plot(mo.time, (mo.voc-mo.Voc_stat), marker=1, markersize='3', markevery=12, linestyle='None', color='black', label='mo.voc-mo.Voc_stat')
