...
def overall(mo, mv, so, sv, smv, filename, fig_files=None, plot_title=None, n_fig=None, plot_init_in=False,
    ...
    if mo.ibmh is not None:
        ...
        plt.legend(loc=1)
        plt.subplot(338)
        plt.plot(mo.time, mo.mod_data, color='blue', linestyle='-', label='mod'+old_str)
        plt.plot(mv.time, mv.mod_data, color='red', linestyle='--', label='mod'+new_str)
        plt.plot(mo.time, mo.sat+2, color='black', linestyle='-',  label='sat'+old_str+'+2')
        plt.plot(mv.time, np.array(mv.sat)+2, color='green', linestyle='--', label='sat_ver'+old_str+'+2')
        plt.plot(mo.time, np.array(mo.bms_off)+4, color='red', linestyle='-', label='bms_off'+old_str+'+4')
        plt.plot(mv.time, np.array(mv.bms_off)+4, color='green', linestyle='--', label='bms_off_ver'+old_str+'+4')
        if so is not None:
        ...
        plt.plot(mo.time, mo.voc_soc+0.1*0, color='black', linestyle='-.', label='voc_soc'+old_str+'+0.1')
        plt.plot(mo.time, mo.voc+0.1*0, color='cyan', linestyle=':', label='voc'+old_str+'+0.1')
        plt.plot(mv.time, np.array(mv.voc)+0.1*0, color='red', linestyle=':', label='voc_ver'+old_str+'+0.1')
        plt.legend(loc=1)
        plt.subplot(335)
        plt.plot(mo.time, mo.e_wrap, color='magenta', linestyle='-', label='e_wrap'+old_str)
    ...
    if so and smv:
        ...
        plt.plot(mv.time, np.array(mv.ib_charge)-1, color='orange', linestyle='--', label='ib_charge_ver'+old_str+'-1')
        plt.plot(so.time, np.array(so.ib_charge_s)-1, color='blue', linestyle='-.', label='ib_charge_s'+old_str+'-1')
        plt.plot(smv.time, np.array(smv.ib_charge_s)-1, color='red', linestyle=':', label='ib_charge_s_ver'+old_str+'-1')
        plt.legend(loc=1)
        plt.subplot(332)
        ...
        if hasattr(sv, 'chm'):
            plt.plot(sv.time, np.array(sv.chm)+4, color='red', linestyle='-', label='sv.chm_ver'+old_str+'+4')
        elif hasattr(sv, 'chm_s'):
            plt.plot(sv.time, np.array(sv.chm_s)+4, color='red', linestyle='-', label='sv.chm_ver'+old_str+'+4')
        plt.plot(smv.time, np.array(smv.chm_s)+4, color='black', linestyle='--', label='smv.chm_s_ver'+old_str+'+4')
        plt.legend(loc=1)
        fig_file_name = filename + '_' + str(n_fig) + ".png"
        fig_files.append(fig_file_name)
        plt.savefig(fig_file_name, format="png")
        ...
        plt.plot(mo.time, mo.voc_stat, color='green', linestyle='-.', label='voc_stat'+old_str)
        if mo.vb_h is not None:
            plt.plot(mo.time, mo.voc_soc, color='black', linestyle=':', label='voc_soc'+old_str)
            plt.plot(mo.time, mo.vb_h, color='cyan', linestyle=':', label='vb_hdwe'+old_str)
        plt.legend(loc=1)
        plt.subplot(332)
        ...
        plt.plot(mv.time, mv.voc, color='blue', linestyle='--', label='voc'+new_str)
        plt.plot(mv.time, mv.voc_stat, color='green', linestyle='-.', label='voc_stat'+new_str)
        plt.legend(loc=1)
        plt.subplot(335)
        plt.plot(smv.time, smv.vb_s, color='red', linestyle='-', label='vb_s'+new_str)
        plt.plot(smv.time, smv.voc_s, color='blue', linestyle='--', label='voc_s'+new_str)
        plt.plot(mv.time, mv.voc_soc, color='cyan', linestyle='-.', label='voc_soc'+new_str)
        plt.plot(smv.time, smv.voc_stat_s, color='green', linestyle=':', label='voc_stat_s'+new_str)
        plt.legend(loc=1)
        plt.subplot(337)
        plt.plot(mo.time, mo.soc, color='orange', linestyle='-', label='soc'+old_str)
        plt.plot(mo.time, mo.soc_ekf, color='blue',  linestyle='--', label='soc_ekf'+old_str)
        plt.plot(mv.time, mv.soc, color='cyan', linestyle='-.', label='soc'+new_str)
        plt.plot(mv.time, mv.soc_ekf, color='red', linestyle=':', label='soc_ekf'+new_str)
        plt.legend(loc=1)
        plt.subplot(338)
        ...
        plt.subplot(333)
        plt.plot(mo.time, mo.vb, color='red', linestyle='-', label='vb'+old_str)
        plt.plot(so.time, so.vb_s, color='blue', linestyle='--',  label='vb_s'+old_str)
        plt.plot(mv.time, mv.vb, color='black', linestyle='-.', label='vb'+new_str)
        plt.plot(smv.time, smv.vb_s, color='green', linestyle=':', label='vb_s'+new_str)
        plt.legend(loc=1)
        plt.subplot(336)
        ...
        plt.plot(so.time, so.voc_s, color='blue', linestyle='-.', label='voc_s'+old_str)
        plt.plot(smv.time, smv.voc_s, color='green', linestyle=':', label='voc_s'+new_str)
        plt.legend(loc=1)
        plt.subplot(339)
        ...
        if hasattr(sv, 'soc'):
            plt.plot(sv.time, np.array(sv.soc)-.2, color='orange', linestyle='-', label='sv.soc_s_ver'+old_str+'-0.2')
        elif hasattr(sv, 'soc_s'):
            plt.plot(sv.time, np.array(sv.soc_s)-.2, color='orange', linestyle='-', label='sv.soc_s_ver'+old_str+'-0.2')
        plt.plot(smv.time, np.array(smv.soc_s)-.2, color='black', linestyle='--', label='smv.soc_s_ver'+old_str+'-0.2')
        plt.legend(loc=1)
        plt.subplot(222)
        if mo.vb_h is not None:
    ...
    plt.plot(mv.time, mv.vb, color='orange', linestyle='--', label='vb'+new_str)
    plt.plot(mv.time, mv.voc, color='blue', linestyle='-.', label='voc'+new_str)
    plt.plot(mv.time, mv.voc_stat, color='red', linestyle=':', label='voc_stat'+new_str)
    plt.legend(loc=1)
    plt.subplot(332)
    plt.plot(mv.time, mv.dv_hys, linestyle='--', color='orange', label='dv_hys'+new_str)
    plt.legend(loc=1)
    ...
    if so is not None:
        plt.plot(so.time, so.ib_s, linestyle='--', color='cyan', label='ib_in_s'+old_str)
        plt.plot(so.time, so.ib_charge_s, linestyle='-.', color='blue', label='ib_charge_s'+old_str)
    if smv is not None:
        plt.plot(smv.time, smv.ib_charge_s, linestyle=':', color='red', label='ib_charge_s'+new_str)
    plt.legend(loc=1)
    plt.subplot(335)
    plt.plot(mo.time, mo.voc_soc, linestyle='-', color='black', label='voc_soc'+old_str)
    plt.plot(mv.time, mv.voc_soc, linestyle='--', color='orange', label='voc_soc'+new_str)
    ...
    plt.legend(loc=1)
    plt.subplot(336)
    plt.plot(mo.time, np.array(mo.voc_soc) - np.array(mo.voc_stat), linestyle='-', color='black', label='voc_soc - voc_stat '+old_str)
    plt.plot(mv.time, np.array(mv.voc_soc) - np.array(mv.voc_stat), linestyle='--', color='orange', label='voc_soc_ver - voc_stat '+new_str)
    plt.plot(mo.time, mo.e_wrap, color='magenta', linestyle='-.', label='e_wrap'+old_str)
    plt.plot(mv.time, np.array(mv.voc_soc) - np.array(mv.voc_stat), linestyle=':', color='blue', label='voc_soc_ver - voc_stat '+new_str)
    plt.legend(loc=1)
    plt.subplot(337)
    plt.plot(mo.time, mo.dv_dyn, color='black', linestyle='-', label='dv_dyn'+old_str)
    plt.plot(mv.time, mv.dv_dyn, color='orange', linestyle='--', label='dv_dyn'+new_str)
    plt.legend(loc=1)
    plt.subplot(338)
    plt.plot(mo.time, mo.dv_hys, color='blue', linestyle='-.', label='dv_hys'+old_str)
    plt.plot(mv.time, mv.dv_hys, color='red', linestyle=':', label='dv_hys'+new_str)
    plt.legend(loc=1)
    fig_file_name = filename + '_' + str(n_fig) + ".png"
    fig_files.append(fig_file_name)
    plt.savefig(fig_file_name, format="png")
