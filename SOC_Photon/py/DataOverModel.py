...
def overall(mo, mv, so, sv, smv, filename, fig_files=None, plot_title=None, n_fig=None, plot_init_in=False):
    ...
    if mo.ibmh is not None:
        ...
        plt.plot(mo.time, mo.ib_diff, color='black', linestyle='-.', label='ib_diff')
        plt.plot(mo.time, mo.ib_diff_f, color='magenta', linestyle=':', label='ib_diff_f')
        plt.plot(mo.time, mo.ibd_thr, color='black', linestyle='--', label='ib_diff_thr')
        ...
        plt.subplot(335)
        plt.plot(mo.time, mo.e_w, color='magenta', linestyle='-', label='e_wrap')
        plt.plot(mv.time, mv.e_wrap, color='cyan', linestyle='--', label='e_wrap_ver')
        plt.plot(mo.time, mo.e_w_f, color='black', linestyle='-.', label='e_wrap_filt')
        plt.plot(mv.time, mv.e_wrap_filt, color='red', linestyle=':', label='e_wrap_filt_ver')
    ...
    plt.legend(loc=1)
    plt.subplot(223)
    plt.plot(mo.time, mo.soc_s, color='blue', linestyle='-.', label='soc_s')
    plt.plot(mv.time, mv.soc_s, color='red', linestyle=':', label='soc_s_ver')
    plt.legend(loc=1)
    plt.subplot(224)
    plt.plot(mo.time, mo.soc, color='blue', linestyle='-', label='soc')
    plt.plot(mv.time, mv.soc, color='red', linestyle='--', label='soc_ver')
    ...
    if so and smv:
        ...
        plt.legend(loc=1)
        plt.subplot(338)
        plt.plot(so.time, so.reset_s, color='magenta', linestyle='-', label='reset_s')
        plt.plot(smv.time, smv.reset_s, color='green', linestyle='--', label='reset_s_ver')
        plt.plot(so.time, so.sat_s, color='blue', linestyle='-.', label='sat_s')
        plt.plot(smv.time, smv.sat_s, color='red', linestyle=':', label='sat_s_ver')
        plt.legend(loc=1)
        plt.subplot(339)
        ...
        plt.plot(mv.time, mv.voc_soc, color='cyan', linestyle='-.', label='voc_soc_ver')
        plt.plot(smv.time, smv.voc_stat_s, color='green', linestyle=':', label='voc_stat_s_ver')
        plt.legend(loc=1)
        plt.subplot(337)
        plt.plot(mo.time, mo.soc, color='orange', linestyle='-', label='soc')
        ...
        plt.plot(mv.time, mv.dv_hys, linestyle='--', color='orange', label='dv_hys_ver')
        plt.legend(loc=1)
        plt.subplot(223)
        plt.plot(mo.time, mo.soc, linestyle='-', color='black', label='soc')
    ...
    plt.plot(mv.time, mv.dv_hys, color='red', linestyle=':', label='dv_hys_ver')
    plt.legend(loc=1)
    fig_file_name = filename + '_' + str(n_fig) + ".png"
    fig_files.append(fig_file_name)
    plt.savefig(fig_file_name, format="png")
