...
def overall(mo, mv, so, sv, smv, filename, fig_files=None, plot_title=None, n_fig=None):
    ...
    if so and smv:
        ...
        plt.plot(mv.time, mv.dv_hys, marker='.', markersize='1', markevery=4, linestyle='None', color='magenta', label='dV_hys_ver')
        plt.plot(so.time, so.dv_hys_s, linestyle=':', color='cyan', label='dv_hys_s')
        plt.plot(sv.time, sv.dv_hys, marker='.', markersize='1', markevery=5, linestyle='None', color='black', label='dv_hys_s_ver')
