...
if __name__ == '__main__':
    ...
    def main():
        ...
        # input_files = ['hist v20230205 20230206.txt']; chm_in = 1; rated_batt_cap_in = 100.; scale_in = 1.118; sres0_in = 3.; sresct_in = 0.76; stauct_in = 0.8; s_hys_chg_in = 1; s_hys_dis_in = 1; s_cap_chg_in = 1.; s_cap_dis_in = 1.; myCH_Tuner_in = 4  # 0.9 - 1.0 Tune 3
        input_files = ['serial_20230206_141936.txt', 'serial_20230210_133437.txt', 'serial_20230211_151501.txt', 'serial_20230212_202717.txt',
                       ...
                       'serial_20230227_130855.txt']; chm_in = 1;  rated_batt_cap_in = 100.; scale_in = 1.118; cc_dif_tol_in = 0.5
