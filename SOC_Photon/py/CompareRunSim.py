...
if __name__ == '__main__':
    ...
    def main():
        ...
        # data_file_old_txt = 'rapidTweakRegression v20230209 CHINS.txt'; unit_key = 'pro0p_2023';  scale_in=1.05; sres_in = 1.8; staudif_in = 0.25; coul_eff_in = 0.9973; s_hys_cap_in = 10;#0.8 tune 2# ; time_end_in=4.8;
...
# ##        # data_file_old_txt = 'steps v20230128 20230204.txt'; unit_key = 'soc0p';  scale_in=1.05; sres_in = 1.6; staudif_in = 0.3; s_hys_chg_in = 0.5; s_hys_dis_in = 0.5; s_cap_chg_in = 0.5; s_cap_dis_in = 0.5;  myCH_Tuner_in = 2; #0.8 tune 2
        data_file_old_txt = 'steps v20230128 20230204.txt'; unit_key = 'soc0p';  scale_in=1.05; sres_in = 1.6; staudif_in = 0.3; s_hys_chg_in = 0.4; s_hys_dis_in = 0.3; s_cap_chg_in = 0.3; s_cap_dis_in = 0.3;  myCH_Tuner_in = 2; #0.8 tune 2
