...
class Battery(Coulombs):
    ...
    def __init__(self, t_t=None, t_b=None, t_a=None, t_c=None, m=0.478, n=0.4, d=0.707,
        ...
        t_x_soc = [0.00, 0.10, 0.20, 0.30, 0.40,  0.50,  0.60,  0.70,  0.73,  0.76,  0.78,  0.80,  0.90,  0.98,  1.00]
        t_y_t = [0., 10., 15., 20., 40.]
        t_voc = [4.00,4.00,  4.00,  4.00,  4.00,  4.00,  4.00,  4.00,  7.00,  10.24, 11.32, 11.83, 12.63, 13.02, 13.32,
                4.30, 4.30,  4.30,  4.30,  4.30,  4.30,  4.30,  4.30,  7.30,  10.45, 11.54, 12.04, 12.85, 13.20, 13.50,
                4.50, 4.50,  4.50,  4.50,  4.50,  4.50,  4.50,  10.50, 12.40, 12.60, 12.72, 12.75, 13.09, 13.35, 13.72,
                9.38, 12.18, 12.83, 12.99, 13.18, 13.21, 13.28, 13.38, 13.422,13.422,13.44, 13.45, 13.49, 13.57, 13.92,
