...
## Implementation Notes
  ...
  28. To run tweak test: Xx2; Xts; Xf0.02; Xa-4000;  then hard reset then m1; Ri;   To end:  Xp0; v2;   Transfer tweak_bias to CURR_BIAS_AMP and CURR_BIAS_NOAMP in local_config.h; otherwise max_tweak will begin to limit.
