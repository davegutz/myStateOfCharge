...
## Implementation Notes
  ...
  v0; Bm0; Bs0; Xx2; Xts; Xf0.02; Xa-2000;
  ...
  32. The Coulomb Counter is reset to the EKF after 30 seconds with more than 5% error from EKF.   Initialization takes care of this automatically.  The EKF must be converged within threshold for time(EKF_CONV & EKF_T_CONV).
  ...
  36. Regression test slow tweak test 8 min:
    ...
    set Da so ib=0 with Ca0.5 after cycling through sequence below as tria
    start recording
  v0; Bm0; Bs0; Xx2; Xts; Xf0.002; Xa-60;
    reset
  Ca1; Ri; Mw0; Nw0; NC0.5; MC0.5; Nx10; Mx10; v4;
    To end:
  Xp0; v4;
