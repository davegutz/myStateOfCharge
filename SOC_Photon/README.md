...
## Implementation Notes
  ...
  29. readADC_Differential_0_1 has count_max logic to prevent forever waiting.   There is an optimum because if wait to long it creates cascade wait race in rest of application.  50: inf events.  100:0-4 events.  200:  5 events.   800:  25 events.  You can reproduce the problem by sendind "Hd" wile running the tweak test of previous item.
