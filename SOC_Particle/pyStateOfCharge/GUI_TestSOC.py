...
modLowInitCHG = 'Xm247;Ca-0.01;BZ;Ff0;DP1;HR;Rf;XD;'
...
lookup = {
        ...
        'offSitHysBmsCH': (625, modLowInitCH + slowTwitchDef + 'Xa-162;' + tranPrep + twitch + 'XQ568000;' + 'Xa0;' + quiet + cleanup, ('for CompareRunRun.py Argon vs Photon builds. This is the only test for that.',)),
        'offSitHysBmsCHG': (625, modLowInitCHG + slowTwitchDef + 'Xa-162;' + tranPrep + twitch + 'XQ568000;' + 'Xa0;' + quiet + cleanup, ('for CompareRunRun.py Argon vs Photon builds. This is the only test for that.',)),
