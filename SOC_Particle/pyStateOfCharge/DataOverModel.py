...
def dom_plot(mo, mv, so, sv, smv, filename, fig_files=None, plot_title=None, fig_list=None, plot_init_in=False,
    ...
    plq(plt, mv, 'time', mo, 'wl_n_fa', add=+2, color='orange', linestyle='-.', label='wrap_lo_fa' + ref_str + '+2')
    plq(plt, mv, 'time', mv, 'wl_n_fa', add=+2, color='yellow', linestyle='-.', label='wrap_lo_n_fa' + test_str + '+2')
    plt.legend(loc=1)
    plt.subplot(236)
    ...
    plq(plt, mv, 'time', mv, 'e_wrap_m_trim', color='black', linestyle='-', label='e_wrap_m_trim' + test_str)
    ...
    plq(plt, mv, 'time', mv, 'e_wrap_n_trim', color='black', linestyle='-', label='e_wrap_n_trim' + test_str)
