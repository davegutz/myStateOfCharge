...
def dom_plot(mo, mv, so, sv, smv, filename, fig_files=None, plot_title=None, fig_list=None, plot_init_in=False,
    ...
    plt.legend(loc=1)
    plt.subplot(232)
    plt.plot(mo.time, mo.wh_flt + 12, color='green', linestyle='-', label='wrap_hi_flt' + ref_str + '+12')
    plq(plt, mv, 'time', mv, 'wh_flt', add=+12, color='red', linestyle='--', label='wrap_hi_flt' + test_str + '+12')
    plq(plt, mo, 'time', mo, 'wh_m_flt', +10, color='green', linestyle='-', label='wrap_hi_m_flt' + ref_str + '+10')
    plq(plt, mv, 'time', mv, 'wh_m_flt', +10, color='red', linestyle='--', label='wrap_hi_m_flt' + test_str + '+10')
    plq(plt, mo, 'time', mo, 'wh_n_flt', +8, color='green', linestyle='-', label='wrap_hi_n_flt' + ref_str + '+8')
    plq(plt, mv, 'time', mv, 'wh_n_flt', +8, color='red', linestyle='--', label='wrap_hi_n_flt' + test_str + '+8')
    ...
    plq(plt, mo, 'time', mo, 'wl_m_flt', +4, color='green', linestyle='-', label='wrap_lo_m_flt' + ref_str + '+4')
    plq(plt, mv, 'time', mv, 'wl_m_flt', +4, color='red', linestyle='--', label='wrap_lo_m_flt' + test_str + '+4')
    plq(plt, mo, 'time', mo, 'wl_n_flt', +2, color='green', linestyle='-', label='wrap_lo_n_flt' + ref_str + '+2')
    plq(plt, mv, 'time', mv, 'wl_n_flt', +2, color='red', linestyle='--', label='wrap_lo_n_flt' + test_str + '+2')
    plt.legend(loc=1)
    plt.subplot(235)
    ...
    plq(plt, mo, 'time', mo, 'e_wm_f', color='black', linestyle=':', label='e_wrap_m_filt' + ref_str)
    plq(plt, mo, 'time', mo, 'e_wrap_m_filt', color='orange', linestyle=':', label='e_wrap_m_filt' + ref_str)
    plq(plt, mv, 'time', mv, 'e_wm_f', color='blue', linestyle='-.', label='e_wrap_m_filt' + test_str)
    plq(plt, mo, 'time', mo, 'e_wn_f', color='red', linestyle=':', label='e_wrap_n_filt' + ref_str)
    plq(plt, mo, 'time', mo, 'e_wrap_n_filt', color='yellow', linestyle=':', label='e_wrap_n_filt' + ref_str)
    plq(plt, mv, 'time', mv, 'e_wn_f', color='orange', linestyle='--', label='e_wrap_n_filt' + test_str)
    plq(plt, mo, 'time', mo, 'ewh_thr', color='black', linestyle='-.', label='ewh_thr' + ref_str)
    plq(plt, mo, 'time', mo, 'ewl_thr', color='black', linestyle='-.', label='ewl_thr' + ref_str)
