...
def compare_hist_hist(data_file=None, unit_key=None, dt_resample=10, data_only=False, time_end_in=None):
    ...
    mon_old, sim_old, unit, fault, hist_20C, filename = \
        load_hist_and_prep(data_file=data_file, unit_key=unit_key, dt_resample=dt_resample)
...
def main():
    ...
    compare_hist_hist(data_file=data_file, unit_key=unit_key, dt_resample=dt_resample)
