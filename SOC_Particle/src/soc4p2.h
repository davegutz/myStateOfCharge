...
#define HDWE_INA181_NOA_LO  -11.0       // Full NOA discharge transition, A (-20)
#define HDWE_INA181_AMP_LO  -10.0       // Full AMP discharge transition, A (-18)  
#define HDWE_INA181_AMP_HI   10.0       // Full AMP charge transition, A (17)
#define HDWE_INA181_NOA_HI   11.0       // Full NOA charge transition, A (19)
