...
class Chemistry(BMS):
    ...
    def assign_CH(self):
        ...
        t_voc1 = [4.000,   4.000,   4.000,   4.000,   4.592,  5.480,  6.963,  10.292,  12.971,  13.025,  13.059,  13.107,  13.152,  13.205,  13.243,  13.284,  13.299,  13.310,  13.486,  14.700,
        ...
        t_soc_min1 = [0.167,   0.167,   0.014,   0.11,   0.11]
