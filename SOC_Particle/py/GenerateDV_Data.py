...
voc_stat = vb
dv = dv_max
Hyst = LagExp(dt=T, max_=dv_max/2., min_=-dv_max/2., tau=tau)
...
for i in range(n):
    ...
    dv = Hyst.calculate(ib_charge, reset, T)
    voc_stat = voc_soc + dv
    ...
    sat = voc_soc > vsat
    if reset:
        print('unit,               hm,                  cTime,       dt,       chm,qcrs,sat,sel,mod,bmso, Tb,  vb,  ib,   ib_charge, ioc, voc_soc,    vsat,dv_dyn,voc_stat,voc_ekf,     y_ekf,    soc_s,soc_ekf,soc,soc_min, dv,')
    print("{:s}, {:s},{:12.3f},{:6.3f},{:2d},{:8.0f},  {:2d}, {:2d}, {:2d}, {:2d},{:7.3f},{:7.3f},{:7.3f},{:7.3f},{:7.3f},{:7.3f},{:7.3f},{:7.3f},{:7.3f},{:7.3f},{:7.3f},{:7.3f},{:7.3f},{:7.3f},{:7.3f},{:7.3f},"\
