...
def train_tensor_lstm():
    ...
    train_files = [".//temp//dv_train_soc0p_ch_clip01_clean.csv", ".//temp//dv_train_soc0p_ch_clip02_clean.csv",
                   ".//temp//dv_train_soc0p_ch_clip03_clean.csv", ".//temp//dv_train_soc0p_ch_clip04_clean.csv"]
