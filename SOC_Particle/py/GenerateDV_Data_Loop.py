...
if prof_type == 'simple':
    csv_file = "generateDV_Data_Loop_simple_20230916.csv"
    ...
    csv_file = "generateDV_Data_Loop_step_20230916.csv"
    profile = [(0., 0., .9, 5400.), (-10., 0., .9, 5400.), (-9., 0., 1., 5400.), (-8., 0., 1., 5400.),
               ...
               (8., 0., 1., 5400.), (9., 0., 1., 5400.), (10., 0., 1., 5400.),
               (0., 0., 1., 19600.)]
