...
lookup = {'init': ('Y;c;Dh1800000;*W;*vv0;*XS;*Ca1;<HR;<Rf;<Hd;<Pf;', ('',), 10, 12),
          ...
          'triTweakDisch': ('Ff0;HR;Pf;Xp13;', ('Should run three very large current discharge/recharge cycles without fault', 'Best test for seeing time skews and checking fault logic for false trips'), 180, 12),
