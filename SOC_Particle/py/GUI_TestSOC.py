...
lookup = {
        ...
        'rapidTweakRegression40C': (199, 'D^15;Xp10' + quiet + cleanup, ("Should run three very large current discharge/recharge cycles without fault", "Self-terminates")),
