...
lookup = {'init': ('Y*W;*v0;*XS;*Ca0.5;+Rf;+Pf;', '', ('',), 0),
          ...
          'offSitHysBmsBB': ('Ff0;Xp0;Xm247;Ca0.05;Rb;Rf;Dr100;DP1;Xts;Xa-162;Xf0.004;XW10;XT10;XC2;W1;Ph;HR;Pf;v2;W1;XR;', ('for CompareRunRun.py Argon vs Photon builds. This is the only test for that.',), 568, 12),
          'offSitHysBmsCH': ('Ff0;Xp0;Xm247;Ca0.103;Rb;Rf;Dr100;DP1;Xts;Xa-162;Xf0.004;XW10;XT10;XC2;W1;Ph;HR;Pf;v2;W1;XR;', ('for CompareRunRun.py Argon vs Photon builds. This is the only test for that.',), 568, 12),
          ...
          'coldStart': ('Ff0;D^-18;Xp0;Xm247;Fi1000;Fo1000;Ca0.93;Ds0.06;Sk0.5;Rb;Rf;Dr100;DP1;v2;W100;DI40;Fi1;Fo1;', ("Should charge for a bit after hitting cutback on BMS.   Should see current gradually reduce.   Run until 'SAT' is displayed.   Could take ½ hour.", "The Ds term biases voc(soc) by delta x and makes a different type of saturation experience, to accelerate the test.", "Look at chart 'DOM 1' and verify that e_wrap misses ewlo_thr (thresholds moved as result of previous failures in this transient)", "Don't remember why this problem on cold day only."), 220, 12),
          'ampHiFailFf': ('Ff1;Xm247;Ca0.5;Dr100;DP1;HR;Pf;v2;Dm50;Dn0.0001;', ("Should detect but not switch amp current failure. (See 'diff' and current!=0 on OLED).", "Run about 60s. Start by looking at 'DOM 1' fig 3. No fault record (keeps recording).  Verify that on Fig 3 the e_wrap goes through a threshold ~0.4 without tripping faults.", "This show when deploy with Fake Faults (Ff) don't throw false trips (it happened)", "ib_diff_fa will set red_loss but wait for wrap_fa to isolate and make selection change"), 60, 12),
          'ampLoFail': ('Ff0;Xm247;Ca0.5;Dr100;DP1;HR;Pf;v2;Dm-50;Dn0.0001;', ("Should detect and switch amp current failure.", "Start looking at 'DOM 1' fig 3. Fault record (frozen). Will see 'diff' flashing on OLED even after fault cleared automatically (lost redundancy).", "ib_diff_fa will set red_loss but wait for wrap_fa to isolate and make selection change"), 40, 12),
          'ampHiFailNoise': ('Ff0;Xm247;Ca0.5;Dr100;DP1;HR;Pf;v2;DT.05;DV0.05;DM.2;DN2;Dm50;Dn0.0001;Ff0;', ("Noisy ampHiFail.  Should detect and switch amp current failure.", "Start looking at 'DOM 1' fig 3. Fault record (frozen). Will see 'diff' flashing on OLED even after fault cleared automatically (lost redundancy).", "ib_diff_fa will set red_loss but wait for wrap_fa to isolate and make selection change"), 40, 12),
          ...
          'satSitBB': ('Ff0;Xp0;Xm247;Ca0.9962;Rb;Rf;Dr100;DP1;Xts;Xa17;Xf0.002;XW10;XT10;XC1;W1;HR;Pf;v2;W1;XR;', ("Should run one saturation and de-saturation event without fault.   Takes about 15 minutes.", "operate around saturation, starting below, go above, come back down. Tune Ca to start just below vsat",), 600, 12),
          'satSitCH': ('Ff0;Xp0;Xm247;Ca0.992;Rb;Rf;Dr100;DP1;Xts;Xa17;Xf0.002;XW10;XT10;XC1;W1;HR;Pf;v2;W1;XR;', ("Should run one saturation and de-saturation event without fault.   Takes about 15 minutes.", "operate around saturation, starting below, go above, come back down. Tune Ca to start just below vsat",), 600, 12),
          'flatSitHys': ('Ff0;Xp0;Xm247;Ca0.9;Rb;Rf;Dr100;DP1;Xts;Xa-81;Xf0.004;XW10;XT10;XC2;W1;Ph;HR;Pf;v2;W1;XR;', ("Operate around 0.9.  For CHINS, will check EKF with flat voc(soc).   Takes about 10 minutes.", "Make sure EKF soc (soc_ekf) tracks actual soc without wandering."), 568, 12),
          'offSitHysBmsNoiseBB': ('Ff0;Xp0;Xm247;Ca0.05;Rb;Rf;Dr100;DP1;Xts;Xa-162;Xf0.004;XW10;XT10;XC2;W2;DT.05;DV0.10;DM.2;DN2;Ph;HR;Pf;v2;W1;XR;', ("Stress test with 2x normal Vb noise DV0.10.  Takes about 10 minutes.", "operate around saturation, starting above, go below, come back up. Tune Ca to start just above vsat. Go low enough to exercise hys reset ", "Make sure comes back on.", "It will show one shutoff only since becomes biased with pure sine input with half of down current ignored on first cycle during the shutoff."), 568, 12),
          'offSitHysBmsNoiseCH': ('Ff0;Xp0;Xm247;Ca0.103;Rb;Rf;Dr100;DP1;Xts;Xa-162;Xf0.004;XW10;XT10;XC2;W2;DT.05;DV0.10;DM.2;DN2;Ph;HR;Pf;v2;W1;XR;', ("Stress test with 2x normal Vb noise DV0.10.  Takes about 10 minutes.", "operate around saturation, starting above, go below, come back up. Tune Ca to start just above vsat. Go low enough to exercise hys reset ", "Make sure comes back on.", "It will show one shutoff only since becomes biased with pure sine input with half of down current ignored on first cycle during the shutoff."), 568, 12),
          'ampHiFailSlow': ('Ff0;Xm247;Ca0.5;Pf;v2;W2;Dr100;DP1;HR;Dm6;Dn0.0001;Fc0.02;Fd0.5;', ("Should detect and switch amp current failure. Will be slow (~6 min) detection as it waits for the EKF to wind up to produce a cc_diff fault.", "Will display “diff” on OLED due to 6 A difference before switch (not cc_diff).", "EKF should tend to follow voltage while soc wanders away.", "Run for 6  minutes to see cc_diff_fa"), 400, 12),
          'vHiFail': ('Ff0;Xm247;Ca0.5;Dr100;DP1;HR;Pf;v2;W50;Dm0.001;Dv0.82;', ("Should detect voltage failure and display '*fail' and 'redl' within 60 seconds.", "To diagnose, begin with DOM 1 fig. 2 or 3.   Look for e_wrap to go through ewl_thr.", "You may have to increase magnitude of injection (Dv).  The threshold is 32 * r_ss.", "There MUST be no SATURATION"), 60, 12),
          'vHiFailH': ('Ff0;Xm247;Ca0.5;Dr100;DP1;HR;Pf;v2;W50;SH.3;W10;Dm0.001;Dv0.82;', ("Should detect voltage failure and display '*fail' and 'redl' within 60 seconds.", "To diagnose, begin with DOM 1 fig. 2 or 3.   Look for e_wrap to go through ewl_thr.", "You may have to increase magnitude of injection (Dv).  The threshold is 32 * r_ss.", "There MUST be no SATURATION.  Initial BB shift will be limited by hys table"), 40, 12),
          'vHiFailFf': ('Ff1;Xm247;Ca0.5;Dr100;DP1;HR;Pf;v2;W10;Dv0.8;', ("Run for about 1 minute.", "Should detect voltage failure (see DOM1 fig 2 or 3) but not display anything on OLED.", "Usually shows SAT."), 60, 12),
          'pulseEKF': ("Xp6; doesn't work", ("Xp6 # TODO: doesn't work now.",), 0, 0),
          'pulseSS': ("Xp7;", ("Should generate a very short <10 sec data burst with a sw pulse.  Look at plots for good overlay. e_wrap will have a delay.", "This is the shortest of all tests.  Useful for quick checks."), 0, 1),
          'pulseSSH': ("Xp8;", ("Should generate a very short <10 sec data burst with a hw pulse.  Look at plots for good overlay. e_wrap should be flat.", "This is the shortest of all tests.  Useful for quick checks."), 0, 1),
          'tbFailMod': ('Ff0;Ca.5;Xp0;Xm247;DP1;Dr100;W2;HR;Pf;v2;Xv.002;Xu1;W4;Xu0;Xv1;W20;v0;Pf;', ("Run for 60 sec.   Plots DOM 1 Fig 2 or 3 should show Tb was detected as fault but not failed.",), 60, 12),
          'tbFailHdwe': ('Ff0;Ca.5;Xp0;Xm246;DP1;Dr100;W2;HR;Pf;v2;Xv.002;W10;Xu1;W20;Xu0;Xv1;W20;v0;Pf;', ("Run for 60 sec.   Plots DOM 1 Fig 2 or 3 should show Tb was detected as fault but not failed.", "'Xp0' in reset puts Xm back to 247."), 60, 12),
          'DvMon': ('Ff0;Xm247;Ca0.5;Dr100;DP1;HR;Pf;v2;W30;Dm0.001;Dw-0.8;Dn0.0001;', ("Should detect and switch voltage failure and use vb_model", "'*fail' will be displayed.", "To evaluate plots, start looking at 'DOM 1' fig 3. Fault record (frozen). Will see 'redl' flashing on OLED even after fault cleared automatically (lost redundancy).", "Run for 2 min to confirm no cc_diff_fa"), 120, 12),
          'DvSim': ('Ff0;Xm247;Ca0.5;Dr100;DP1;HR;Pf;v2;W30;Dm0.001;Dy-0.8;Dn0.0001;', ("Should detect and switch voltage failure and use vb_model", "'*fail' will be displayed.", "To evaluate plots, start looking at 'DOM 1' fig 3. Fault record (frozen). Will see 'redl' flashing on OLED even after fault cleared automatically (lost redundancy).", "Run for 2 min to confirm no cc_diff_fa"), 120, 12),
          }
