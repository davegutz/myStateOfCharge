...
lookup = {'init': ('Y;cc;Dh1800000;*W;*vv0;*XS;*Ca1;<HR;<Rf;<Hd;<Pf;', ('',), 10, 12),
          ...
          'rapidTweakRegression': ('Ff0;HR;Pf;Xp10;', ('Should run three very large current discharge/recharge cycles without fault', 'Best test for seeing time skews and checking fault logic for false trips'), 1, 220),
          ...
          'rapidTweakRegressionH0': ('Sh0;SH0;Ff0;HR;Pf;Xp10;', ('Should run three very large current discharge/recharge cycles without fault', 'No hysteresis. Best test for seeing time skews and checking fault logic for false trips', 'Tease out cause of e_wrap faults.  e_wrap MUST be flat!'), 1, 12),
          ...
          'triTweakDisch': ('Ff0;HR;Pf;Xp13;', ('Should run three very large current discharge/recharge cycles without fault', 'Best test for seeing time skews and checking fault logic for false trips'), 1, 12),
