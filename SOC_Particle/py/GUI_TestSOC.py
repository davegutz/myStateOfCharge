...
sel_list = ['init', 'init1', 'custom', 'ampHiFail', 'rapidTweakRegression', 'rapidTweakRegressionH0', 'offSitHysBmsBB', 'offSitHysBmsCH', 'triTweakDisch', 'coldStart', 'ampHiFailFf',
            ...
            'offSitHysBmsNoiseBB', 'offSitHysBmsNoiseCH', 'ampHiFailSlow', 'vHiFail', 'vHiFailH', 'vHiFailFf', 'pulseEKF', 'pulseSS', 'tbFailMod',
...
lookup = {'init': ('v0;XS;Xp0;Ca0.5;DE20;DP4;Dr100;Ds0;D^0;Dv0;Dy0;DT0;DV0;DM0;DN0;Sh1;Sr1;Fc1;Fd1;Ff0;Fi1;Fo1;Fq1;FI0;FT0;FV0;Rf;', '', ('',), 0),
          ...
          'rapidTweakRegression': ('Ff0;HR;Xp10;', 'start timer', ('Should run three very large current discharge/recharge cycles without fault', 'Best test for seeing time skews and checking fault logic for false trips'), 155),
          'rapidTweakRegressionH0': ('Sh0;SH0;Ff0;HR;Xp10;', 'start timer', ('Should run three very large current discharge/recharge cycles without fault', 'No hysteresis. Best test for seeing time skews and checking fault logic for false trips', 'Tease out cause of e_wrap faults'), 155),
          ...
          'rapidTweakRegression40C': ('Ff0;HR;D^15;Xp10;', 'D^0;', ("Should run three very large current discharge/recharge cycles without fault", "Self-terminates"), 155),
          'slowTweakRegression': ('Ff0;HR;Xp11;', 'v0;', ("Should run one very large slow (~15 min) current discharge/recharge cycle without fault.   It will take 60 seconds to start changing current.",), 600),
          ...
          'vHiFailH': ('Ff0;D^0;Xm247;Ca0.5;Dr100;DP1;HR;Pf;v2;W50;SH.3;W50;Dm0.001;Dv0.82;', 'Dv0;Hd;Pf;Xp0;Rf;SH0;W50;+v0;Dr100;Rf;Pf;DP4;', ("Should detect voltage failure and display '*fail' and 'redl' within 60 seconds.", "To diagnose, begin with DOM 1 fig. 2 or 3.   Look for e_wrap to go through ewl_thr.", "You may have to increase magnitude of injection (Dv).  The threshold is 32 * r_ss.", "There MUST be no SATURATION"), 40),
