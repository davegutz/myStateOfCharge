...
sel_list = ['custom', 'init1', 'saveAdjusts', 'ampHiFail', 'rapidTweakRegression', 'allProto', 'pulseSS', 'rapidTweakRegressionH0', 'offSitHysBmsBB',
            'offSitHysBmsCH', 'triTweakDisch', 'ampHiFailFf', 'ampLoFail', 'ampHiFailNoise',
...
lookup = {'init': (22, 'Y;cc;Dh;*W;*vv0;*XS;*Ca1;BZ;Ff0;<HR;<Rf;<Hd;<Pf;<XD;', ('',)),
          ...
          'ampHiFail': (62, 'Xm247;Ca0.5;DP1;Pf;vv4;Dh1000;W;Rs;W18;Dm50;Dn0.0001;XQ40000;Dm0;Dn0;vv0;Dh;Hd;Pf;XD;', ("Should detect and switch amp current failure (reset when current display changes from '50/diff' back to normal '0' and wait for CoolTerm to stop streaming.)", "'diff' will be displayed. After a bit more, current display will change to 0.", "To evaluate plots, start looking at 'DOM 1' fig 3. Fault record (frozen). Will see 'diff' flashing on OLED even after fault cleared automatically (lost redundancy).", "ib_diff_fa will set red_loss but wait for wrap_fa to isolate and make selection change")),
          'rapidTweakRegression': (208, 'HR;Pf;Xp10;vv0;Dh;XD;', ('Should run three very large current discharge/recharge cycles without fault', 'Best test for seeing time skews and checking fault logic for false trips')),
          'allProto': (480, 'Xm247;Ca0.5;DP1;Pf;vv4;Dh1000;W;Rs;W18;Dm50;Dn0.0001;XQ50000;W5;Hd;Pf;HR;Rf;XD;  Pf;Xp10;  Pf;Xp13;  <Dh;XD;', ('Proto multi', "Must have same 'vv*' throughout", "No 'HR' either")),
          ...
          'rapidTweakRegressionH0': (208, 'Sh0;SH0;Ff0;HR;Pf;Xp10;vv0;Dh;XD;', ('Should run three very large current discharge/recharge cycles without fault', 'No hysteresis. Best test for seeing time skews and checking fault logic for false trips', 'Tease out cause of e_wrap faults.  e_wrap MUST be flat!')),
          'offSitHysBmsBB': (590, 'Xm247;Ca0.05;Rb;Rf;DP1;Xts;Xa-162;Xf0.004;XW10000;XT10;XC2;W1;Ph;HR;Pf;vv4;Dh1000;W;Rs;XR;XQ568000;vv0;Dh;Hd;Pf;XD;', ('for CompareRunRun.py Argon vs Photon builds. This is the only test for that.',)),
          'offSitHysBmsCH': (590, 'Xm247;Ca0.103;Rb;Rf;DP1;Xts;Xa-162;Xf0.004;XW10000;XT10;XC2;W1;Ph;HR;Pf;vv4;Dh1000;W;Rs;XR;XQ568000;vv0;Dh;Hd;Pf;XD;', ('for CompareRunRun.py Argon vs Photon builds. This is the only test for that.',)),
          ...
          # 'coldStart': (272, 'D^-18;Xm247;Fi1000;Fo1000;Ca0.93;Sk0.5;Ds-0.06;Rb;Rf;vv4;DP1;Dh1000;W99;DI40;XQ220000;Fi1;Fo1;W10;vv0;Dh;Hd;<Pf;<XD;', ("Should charge for a bit after hitting cutback on BMS.   Should see current gradually reduce.   Run until 'SAT' is displayed.   Could take ½ hour.", "The Ds term biases voc(soc) by delta x and makes a different type of saturation experience, to accelerate the test.", "Look at chart 'DOM 1' and verify that e_wrap misses ewlo_thr (thresholds moved as result of previous failures in this transient)", "Don't remember why this problem on cold day only.")),
          'ampHiFailFf': (30, 'Ff1;Xm247;Ca0.5;DP1;HR;Pf;vv4;Dh1000;W2;Rs;W17;Dm50;Dn0.0001;XQ40000;vv0;Dh;Hd;Pf;XD;', ("Should detect but not switch amp current failure. (See 'diff' and current!=0 on OLED).", "Run about 60s. Start by looking at 'DOM 1' fig 3. No fault record (keeps recording).  Verify that on Fig 3 the e_wrap goes through a threshold ~0.4 without tripping faults.", "This show when deploy with Fake Faults (Ff) don't throw false trips (it happened)", "ib_diff_fa will set red_loss but wait for wrap_fa to isolate and make selection change")),
          'ampLoFail': (72, 'Xm247;Ca0.5;DP1;HR;Pf;vv4;Dh1000;W2;Rs;W17;Dm-50;Dn0.0001;XQ50000;vv0;Dh;Hd;Pf;XD;', ("Should detect and switch amp current failure.", "Start looking at 'DOM 1' fig 3. Fault record (frozen). Will see 'diff' flashing on OLED even after fault cleared automatically (lost redundancy).", "ib_diff_fa will set red_loss but wait for wrap_fa to isolate and make selection change")),
          'ampHiFailNoise': (52, 'Xm247;Ca0.5;DP1;HR;Pf;vv4;Dh1000;Rs;DT.05;DV0.05;DM.2;DN2;Dm50;Dn0.0001;Ff0;XQ40000;vv0;Dh;Hd;Pf;XD;', ("Noisy ampHiFail.  Should detect and switch amp current failure.", "Start looking at 'DOM 1' fig 3. Fault record (frozen). Will see 'diff' flashing on OLED even after fault cleared automatically (lost redundancy).", "ib_diff_fa will set red_loss but wait for wrap_fa to isolate and make selection change")),
          'rapidTweakRegression40C': (208, 'D^15;Xp10;vv0;Dh;XD;', ("Should run three very large current discharge/recharge cycles without fault", "Self-terminates")),
          'slowTweakRegression': (900, 'Xp11;vv0;Dh;XD;', ("Should run one very large slow (~15 min) current discharge/recharge cycle without fault.   It will take 60 seconds to start changing current.",)),
          'satSitBB': (612, 'Xm247;Ca0.9962;Rb;Rf;DP1;Xts;Xa17;Xf0.002;XW10000;XT10;XC1;W1;HR;Pf;vv4;Dh1000;W;Rs;XR;XQ600000;vv0;Dh;Hd;Pf;XD;', ("Should run one saturation and de-saturation event without fault.   Takes about 15 minutes.", "operate around saturation, starting below, go above, come back down. Tune Ca to start just below vsat",)),
          'satSitCH': (612, 'Xm247;Ca0.992;Rb;Rf;DP1;Xts;Xa17;Xf0.002;XW10000;XT10;XC1;W1;HR;Pf;vv4;Dh1000;W;Rs;XR;XQ600000;vv0;Dh;Hd;Pf;XD;', ("Should run one saturation and de-saturation event without fault.   Takes about 15 minutes.", "operate around saturation, starting below, go above, come back down. Tune Ca to start just below vsat",)),
          'flatSitHys': (580, 'Xm247;Ca0.9;Rb;Rf;DP1;Xts;Xa-81;Xf0.004;XW10000;XT10;XC2;W1;Ph;HR;Pf;vv4;Dh1000;W;Rs;XR;XQ580000;vv0;Dh;Hd;Pf;XD;', ("Operate around 0.9.  For CHINS, will check EKF with flat voc(soc).   Takes about 10 minutes.", "Make sure EKF soc (soc_ekf) tracks actual soc without wandering.")),
          'offSitHysBmsNoiseBB': (580, 'Xm247;Ca0.05;Rb;Rf;DP1;Xts;Xa-162;Xf0.004;XW10000;XT10;XC2;W2;DT.05;DV0.10;DM.2;DN2;Ph;HR;Pf;vv4;Dh1000;W;Rs;XR;XQ568000;vv0;Dh;Hd;Pf;XD;', ("Stress test with 2x normal Vb noise DV0.10.  Takes about 10 minutes.", "operate around saturation, starting above, go below, come back up. Tune Ca to start just above vsat. Go low enough to exercise hys reset ", "Make sure comes back on.", "It will show one shutoff only since becomes biased with pure sine input with half of down current ignored on first cycle during the shutoff.")),
          'offSitHysBmsNoiseCH': (580, 'Xm247;Ca0.103;Rb;Rf;DP1;Xts;Xa-162;Xf0.004;XW10000;XT10;XC2;W2;DT.05;DV0.10;DM.2;DN2;Ph;HR;Pf;vv4;Dh1000;W;Rs;XR;XQ568000;vv0;Dh;Hd;Pf;XD;', ("Stress test with 2x normal Vb noise DV0.10.  Takes about 10 minutes.", "operate around saturation, starting above, go below, come back up. Tune Ca to start just above vsat. Go low enough to exercise hys reset ", "Make sure comes back on.", "It will show one shutoff only since becomes biased with pure sine input with half of down current ignored on first cycle during the shutoff.")),
          'ampHiFailSlow': (452, 'Xm247;Ca0.5;Pf;vv4;Dh1000;W;Rs;DP1;HR;Dm6;Dn0.0001;Fc0.02;Fd0.5;XQ400000;vv0;Dh;Hd;Pf;XD;', ("Should detect and switch amp current failure. Will be slow (~6 min) detection as it waits for the EKF to wind up to produce a cc_diff fault.", "Will display “diff” on OLED due to 6 A difference before switch (not cc_diff).", "EKF should tend to follow voltage while soc wanders away.", "Run for 6  minutes to see cc_diff_fa")),
          'vHiFail': (72, 'Xm247;Ca0.5;DP1;HR;Pf;vv4;Dh1000;W;Rs;W48;Dm0.001;Dv0.82;XQ60000;vv0;Dh;Hd;Pf;XD;', ("Should detect voltage failure and display '*fail' and 'redl' within 60 seconds.", "To diagnose, begin with DOM 1 fig. 2 or 3.   Look for e_wrap to go through ewl_thr.", "You may have to increase magnitude of injection (Dv).  The threshold is 32 * r_ss.", "There MUST be no SATURATION")),
          'vHiFailH': (42, 'Xm247;Ca0.5;DP1;HR;Pf;vv4;Dh1000;W;Rs;W48;SH.3;W10;Dm0.001;Dv0.82;XQ30000;vv0;Dh;Hd;Pf;XD;', ("Should detect voltage failure and display '*fail' and 'redl' within 60 seconds.", "To diagnose, begin with DOM 1 fig. 2 or 3.   Look for e_wrap to go through ewl_thr.", "You may have to increase magnitude of injection (Dv).  The threshold is 32 * r_ss.", "There MUST be no SATURATION.  Initial BB shift will be limited by hys table")),
          'vHiFailFf': (72, 'Ff1;Xm247;Ca0.5;DP1;HR;Pf;vv4;W;Rs;W8;Dv0.8;XQ60000;vv0;Dh;Hd;Pf;XD;', ("Run for about 1 minute.", "Should detect voltage failure (see DOM1 fig 2 or 3) but not display anything on OLED.", "Usually shows SAT.")),
          ...
          'tbFailMod': (72, 'Ca.5;Xm247;DP1;W2;HR;Pf;vv4;Dh1000;Rs;Xv.002;Xu1;W4;Xu0;Xv1;W20;vv0;Pf;XQ60000;vv0;Dh;Hd;Pf;XD;', ("Run for 60 sec.   Plots DOM 1 Fig 2 or 3 should show Tb was detected as fault but not failed.",)),
          'tbFailHdwe': (72, 'Ca.5;Xm246;DP1;W2;HR;Pf;vv4;Dh1000;Rs;Xv.002;W10;Xu1;W20;Xu0;Xv1;W20;vv0;Pf;XQ60000;vv0;Dh;Hd;Pf;XD;', ("Run for 60 sec.   Plots DOM 1 Fig 2 or 3 should show Tb was detected as fault but not failed.", "'Xp0' in reset puts Xm back to 247.")),
          'DvMon': (132, 'Xm247;Ca0.5;DP1;HR;Pf;vv4;Dh1000;W30;Dm0.001;Dw-0.8;Dn0.0001;XQ120000;vv0;Dh;Hd;Pf;XD;', ("Should detect and switch voltage failure and use vb_model", "'*fail' will be displayed.", "To evaluate plots, start looking at 'DOM 1' fig 3. Fault record (frozen). Will see 'redl' flashing on OLED even after fault cleared automatically (lost redundancy).", "Run for 2 min to confirm no cc_diff_fa")),
          'DvSim': (132, 'Xm247;Ca0.5;DP1;HR;Pf;vv4;Dh1000;W;Rs;W28;Dm0.001;Dy-0.8;Dn0.0001;XQ120000;vv0;Dh;Hd;Pf;XD;', ("Should detect and switch voltage failure and use vb_model", "'*fail' will be displayed.", "To evaluate plots, start looking at 'DOM 1' fig 3. Fault record (frozen). Will see 'redl' flashing on OLED even after fault cleared automatically (lost redundancy).", "Run for 2 min to confirm no cc_diff_fa")),
          'faultParade': (320, 'Xm247;Ca0.5;DP1;HR;Pf;Dh1000;vv4;Dh1000;Dm50;Dn0.0001;W200;Dm0;Dn0;W20;Rf;XQ240000;vv0;Dh;Hd;Pf;XD;', ("Check fault, history, and summary logging", "Should flag faults but take no action", "", "", "")),
          }
...
if __name__ == '__main__':
    ...
    dum1, init_val, dum2 = lookup.get('init')
