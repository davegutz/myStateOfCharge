...
lookup = {'init': ('Y;cc;Dh1800000;*W;*vv0;*XS;*Ca1;<HR;<Rf;<Hd;<Pf;', ('',), 10, 12),
          ...
          'rapidTweakRegression': ('Ff0;HR;Pf;Xp10;Dh1000;', ('Should run three very large current discharge/recharge cycles without fault', 'Best test for seeing time skews and checking fault logic for false trips'), 180, 12),
          'allProto': ('Ff0;HR;Pf;Xp10;Dh1000;XQ180000;  Ff0;Xm247;Ca0.5;Dr100;DP1;HR;Pf;vv2;Dh1000;W20;Dm50;Dn0.0001;  <Dh;', ('Proto multi', '--'), 20, 250),
          ...
          'rapidTweakRegressionH0': ('Sh0;SH0;Ff0;HR;Pf;Xp10;', ('Should run three very large current discharge/recharge cycles without fault', 'No hysteresis. Best test for seeing time skews and checking fault logic for false trips', 'Tease out cause of e_wrap faults.  e_wrap MUST be flat!'), 180, 12),
          ...
          'triTweakDisch': ('Ff0;HR;Pf;Xp13;Dh1000;', ('Should run three very large current discharge/recharge cycles without fault', 'Best test for seeing time skews and checking fault logic for false trips'), 180, 12),
