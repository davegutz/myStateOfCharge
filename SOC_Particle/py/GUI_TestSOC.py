...
lookup = {'init': ('Y;c;*W;*v0;*XS;*Ca0.5;<Rf;<Pf;', ('',), 10, 12),
          ...
          'offSitHysBmsCH': ('Ff0;Xp0;Xm247;Ca0.103;Rb;Rf;Dr100;DP1;Xts;Xa-162;Xf0.004;XW10000;XT10;XC2;W1;Ph;HR;Pf;v2;W1;XR;', ('for CompareRunRun.py Argon vs Photon builds. This is the only test for that.',), 568, 12),
          ...
          'satSitBB': ('Ff0;Xp0;Xm247;Ca0.9962;Rb;Rf;Dr100;DP1;Xts;Xa17;Xf0.002;XW10000;XT10;XC1;W1;HR;Pf;v2;W1;XR;', ("Should run one saturation and de-saturation event without fault.   Takes about 15 minutes.", "operate around saturation, starting below, go above, come back down. Tune Ca to start just below vsat",), 600, 12),
          'satSitCH': ('Ff0;Xp0;Xm247;Ca0.992;Rb;Rf;Dr100;DP1;Xts;Xa17;Xf0.002;XW10000;XT10;XC1;W1;HR;Pf;v2;W1;XR;', ("Should run one saturation and de-saturation event without fault.   Takes about 15 minutes.", "operate around saturation, starting below, go above, come back down. Tune Ca to start just below vsat",), 600, 12),
          'flatSitHys': ('Ff0;Xp0;Xm247;Ca0.9;Rb;Rf;Dr100;DP1;Xts;Xa-81;Xf0.004;XW10000;XT10;XC2;W1;Ph;HR;Pf;v2;W1;XR;', ("Operate around 0.9.  For CHINS, will check EKF with flat voc(soc).   Takes about 10 minutes.", "Make sure EKF soc (soc_ekf) tracks actual soc without wandering."), 568, 12),
          'offSitHysBmsNoiseBB': ('Ff0;Xp0;Xm247;Ca0.05;Rb;Rf;Dr100;DP1;Xts;Xa-162;Xf0.004;XW10000;XT10;XC2;W2;DT.05;DV0.10;DM.2;DN2;Ph;HR;Pf;v2;W1;XR;', ("Stress test with 2x normal Vb noise DV0.10.  Takes about 10 minutes.", "operate around saturation, starting above, go below, come back up. Tune Ca to start just above vsat. Go low enough to exercise hys reset ", "Make sure comes back on.", "It will show one shutoff only since becomes biased with pure sine input with half of down current ignored on first cycle during the shutoff."), 568, 12),
