...
lookup = {'init': (22, 'Y;cc;Dh;*W;*vv0;*XS;*Ca1;<HR;<Rf;<Hd;<Pf;XQ10000;', ('',) ),
          ...
          'rapidTweakRegression': (208, 'Ff0;HR;Pf;Xp10;Dh;', ('Should run three very large current discharge/recharge cycles without fault', 'Best test for seeing time skews and checking fault logic for false trips')),
          'allProto': (480, 'Ff0;HR;Xm247;Ca0.5;DP1;Pf;vv4;Dh1000;W20;Dm50;Dn0.0001;XQ50000;W5;Rf;  Pf;Xp10;  Pf;Xp13;  <Dh;', ('Proto multi', "Must have same 'vv*' throughout", "No 'HR' either")),
          'pulseSS': (18, "Xp7;Dh;", ("Should generate a very short <10 sec data burst with a sw pulse.  Look at plots for good overlay. e_wrap will have a delay.", "This is the shortest of all tests.  Useful for quick checks.")),
          'rapidTweakRegressionH0': (208, 'Sh0;SH0;Ff0;HR;Pf;Xp10;Dh;', ('Should run three very large current discharge/recharge cycles without fault', 'No hysteresis. Best test for seeing time skews and checking fault logic for false trips', 'Tease out cause of e_wrap faults.  e_wrap MUST be flat!')),
          'offSitHysBmsBB': (580, 'Ff0;Xp0;Xm247;Ca0.05;Rb;Rf;DP1;Xts;Xa-162;Xf0.004;XW10000;XT10;XC2;W1;Ph;HR;Pf;vv2;Dh1000;W1;XR;XQ568000;', ('for CompareRunRun.py Argon vs Photon builds. This is the only test for that.',)),
          'offSitHysBmsCH': (580, 'Ff0;Xp0;Xm247;Ca0.103;Rb;Rf;DP1;Xts;Xa-162;Xf0.004;XW10000;XT10;XC2;W1;Ph;HR;Pf;vv2;Dh1000;W1;XR;XQ568000;', ('for CompareRunRun.py Argon vs Photon builds. This is the only test for that.',)),
          'triTweakDisch': (208, 'Ff0;HR;Pf;Xp13;Dh;', ('Should run three very large current discharge/recharge cycles without fault', 'Best test for seeing time skews and checking fault logic for false trips')),
          'coldStart': (230, 'Ff0;D^-18;Xp0;Xm247;Fi1000;Fo1000;Ca0.93;Ds0.06;Sk0.5;Rb;Rf;DP1;vv2;Dh1000;W100;DI40;Fi1;Fo1;XQ220000;', ("Should charge for a bit after hitting cutback on BMS.   Should see current gradually reduce.   Run until 'SAT' is displayed.   Could take ½ hour.", "The Ds term biases voc(soc) by delta x and makes a different type of saturation experience, to accelerate the test.", "Look at chart 'DOM 1' and verify that e_wrap misses ewlo_thr (thresholds moved as result of previous failures in this transient)", "Don't remember why this problem on cold day only.")),
          'ampHiFailFf': (62, 'Ff1;Xm247;Ca0.5;DP1;HR;Pf;vv2;Dh1000;W20;Dm50;Dn0.0001;XQ40000;Dh;', ("Should detect but not switch amp current failure. (See 'diff' and current!=0 on OLED).", "Run about 60s. Start by looking at 'DOM 1' fig 3. No fault record (keeps recording).  Verify that on Fig 3 the e_wrap goes through a threshold ~0.4 without tripping faults.", "This show when deploy with Fake Faults (Ff) don't throw false trips (it happened)", "ib_diff_fa will set red_loss but wait for wrap_fa to isolate and make selection change")),
          'ampLoFail': (72, 'Ff0;Xm247;Ca0.5;DP1;HR;Pf;vv2;Dh1000;W20;Dm-50;Dn0.0001;XQ50000;Dh;', ("Should detect and switch amp current failure.", "Start looking at 'DOM 1' fig 3. Fault record (frozen). Will see 'diff' flashing on OLED even after fault cleared automatically (lost redundancy).", "ib_diff_fa will set red_loss but wait for wrap_fa to isolate and make selection change")),
          'ampHiFailNoise': (62, 'Ff0;Xm247;Ca0.5;DP1;HR;Pf;vv2;Dh1000;DT.05;DV0.05;DM.2;DN2;Dm50;Dn0.0001;Ff0;XQ40000;Dh;', ("Noisy ampHiFail.  Should detect and switch amp current failure.", "Start looking at 'DOM 1' fig 3. Fault record (frozen). Will see 'diff' flashing on OLED even after fault cleared automatically (lost redundancy).", "ib_diff_fa will set red_loss but wait for wrap_fa to isolate and make selection change")),
          'rapidTweakRegression40C': (208, 'Ff0;HR;D^15;Xp10;Dh;', ("Should run three very large current discharge/recharge cycles without fault", "Self-terminates")),
          'slowTweakRegression': (900, 'Ff0;HR;Xp11;Dh;', ("Should run one very large slow (~15 min) current discharge/recharge cycle without fault.   It will take 60 seconds to start changing current.",)),
          'satSitBB': (612, 'Ff0;Xp0;Xm247;Ca0.9962;Rb;Rf;DP1;Xts;Xa17;Xf0.002;XW10000;XT10;XC1;W1;HR;Pf;vv2;Dh1000;W1;XR;XQ600000;Dh;', ("Should run one saturation and de-saturation event without fault.   Takes about 15 minutes.", "operate around saturation, starting below, go above, come back down. Tune Ca to start just below vsat",)),
          'satSitCH': (612, 'Ff0;Xp0;Xm247;Ca0.992;Rb;Rf;DP1;Xts;Xa17;Xf0.002;XW10000;XT10;XC1;W1;HR;Pf;vv2;Dh1000;W1;XR;XQ600000;Dh;', ("Should run one saturation and de-saturation event without fault.   Takes about 15 minutes.", "operate around saturation, starting below, go above, come back down. Tune Ca to start just below vsat",)),
          'flatSitHys': (580, 'Ff0;Xp0;Xm247;Ca0.9;Rb;Rf;DP1;Xts;Xa-81;Xf0.004;XW10000;XT10;XC2;W1;Ph;HR;Pf;vv2;Dh1000;W1;XR;XQ580000;Dh;', ("Operate around 0.9.  For CHINS, will check EKF with flat voc(soc).   Takes about 10 minutes.", "Make sure EKF soc (soc_ekf) tracks actual soc without wandering.")),
          'offSitHysBmsNoiseBB': (580, 'Ff0;Xp0;Xm247;Ca0.05;Rb;Rf;DP1;Xts;Xa-162;Xf0.004;XW10000;XT10;XC2;W2;DT.05;DV0.10;DM.2;DN2;Ph;HR;Pf;vv2;Dh1000;W1;XR;XQ568000;Dh;', ("Stress test with 2x normal Vb noise DV0.10.  Takes about 10 minutes.", "operate around saturation, starting above, go below, come back up. Tune Ca to start just above vsat. Go low enough to exercise hys reset ", "Make sure comes back on.", "It will show one shutoff only since becomes biased with pure sine input with half of down current ignored on first cycle during the shutoff.")),
          'offSitHysBmsNoiseCH': (580, 'Ff0;Xp0;Xm247;Ca0.103;Rb;Rf;DP1;Xts;Xa-162;Xf0.004;XW10000;XT10;XC2;W2;DT.05;DV0.10;DM.2;DN2;Ph;HR;Pf;vv2;Dh1000;W1;XR;XQ568000;Dh;', ("Stress test with 2x normal Vb noise DV0.10.  Takes about 10 minutes.", "operate around saturation, starting above, go below, come back up. Tune Ca to start just above vsat. Go low enough to exercise hys reset ", "Make sure comes back on.", "It will show one shutoff only since becomes biased with pure sine input with half of down current ignored on first cycle during the shutoff.")),
          'ampHiFailSlow': (452, 'Ff0;Xm247;Ca0.5;Pf;vv2;Dh1000;W2;DP1;HR;Dm6;Dn0.0001;Fc0.02;Fd0.5;XQ400000;Dh;', ("Should detect and switch amp current failure. Will be slow (~6 min) detection as it waits for the EKF to wind up to produce a cc_diff fault.", "Will display “diff” on OLED due to 6 A difference before switch (not cc_diff).", "EKF should tend to follow voltage while soc wanders away.", "Run for 6  minutes to see cc_diff_fa")),
          'vHiFail': (72, 'Ff0;Xm247;Ca0.5;DP1;HR;Pf;vv2;Dh1000;W50;Dm0.001;Dv0.82;XQ60000;Dh;', ("Should detect voltage failure and display '*fail' and 'redl' within 60 seconds.", "To diagnose, begin with DOM 1 fig. 2 or 3.   Look for e_wrap to go through ewl_thr.", "You may have to increase magnitude of injection (Dv).  The threshold is 32 * r_ss.", "There MUST be no SATURATION")),
          'vHiFailH': (42, 'Ff0;Xm247;Ca0.5;DP1;HR;Pf;vv2;Dh1000;W50;SH.3;W10;Dm0.001;Dv0.82;XQ30000;Dh;', ("Should detect voltage failure and display '*fail' and 'redl' within 60 seconds.", "To diagnose, begin with DOM 1 fig. 2 or 3.   Look for e_wrap to go through ewl_thr.", "You may have to increase magnitude of injection (Dv).  The threshold is 32 * r_ss.", "There MUST be no SATURATION.  Initial BB shift will be limited by hys table")),
