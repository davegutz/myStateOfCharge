...
lookup = {'init': (22, 'Y;cc;Dh;*W;*vv0;*XS;*Ca1;BZ;Ff0;<HR;<Rf;<Hd;<Pf;<XD;', ('',)),
          ...
          'offSitHysBmsBB': (590, 'Xp0;Xm247;Ca0.05;Rb;Rf;DP1;Xts;Xa-162;Xf0.004;XW10000;XT10;XC2;W1;Ph;HR;Pf;vv4;Dh1000;W;Rs;XR;XQ568000;vv0;Dh;Hd;Pf;XD;', ('for CompareRunRun.py Argon vs Photon builds. This is the only test for that.',)),
          'offSitHysBmsCH': (590, 'Xp0;Xm247;Ca0.103;Rb;Rf;DP1;Xts;Xa-162;Xf0.004;XW10000;XT10;XC2;W1;Ph;HR;Pf;vv4;Dh1000;W;Rs;XR;XQ568000;vv0;Dh;Hd;Pf;XD;', ('for CompareRunRun.py Argon vs Photon builds. This is the only test for that.',)),
          ...
          'coldStart': (272, 'D^-18;Xp0;Xm247;Fi1000;Fo1000;Ca0.93;Rb;Rf;vv4;DP1;Dh1000;Ds0.06;Sk0.5;W2;W97;DI40;Fi1;Fo1;XQ220000;W10;vv0;Dh;Hd;Pf;XD;', ("Should charge for a bit after hitting cutback on BMS.   Should see current gradually reduce.   Run until 'SAT' is displayed.   Could take ½ hour.", "The Ds term biases voc(soc) by delta x and makes a different type of saturation experience, to accelerate the test.", "Look at chart 'DOM 1' and verify that e_wrap misses ewlo_thr (thresholds moved as result of previous failures in this transient)", "Don't remember why this problem on cold day only.")),
          'ampHiFailFf': (62, 'Ff1;Xm247;Ca0.5;DP1;HR;Pf;vv4;Dh1000;W2;Rs;W17;Dm50;Dn0.0001;XQ40000;vv0;Dh;Hd;Pf;XD;', ("Should detect but not switch amp current failure. (See 'diff' and current!=0 on OLED).", "Run about 60s. Start by looking at 'DOM 1' fig 3. No fault record (keeps recording).  Verify that on Fig 3 the e_wrap goes through a threshold ~0.4 without tripping faults.", "This show when deploy with Fake Faults (Ff) don't throw false trips (it happened)", "ib_diff_fa will set red_loss but wait for wrap_fa to isolate and make selection change")),
          'ampLoFail': (72, 'Xm247;Ca0.5;DP1;HR;Pf;vv4;Dh1000;W2;Rs;W17;Dm-50;Dn0.0001;XQ50000;Dvv0;Dh;Hd;Pf;XD;', ("Should detect and switch amp current failure.", "Start looking at 'DOM 1' fig 3. Fault record (frozen). Will see 'diff' flashing on OLED even after fault cleared automatically (lost redundancy).", "ib_diff_fa will set red_loss but wait for wrap_fa to isolate and make selection change")),
          'ampHiFailNoise': (62, 'Xm247;Ca0.5;DP1;HR;Pf;vv4;Dh1000;Rs;DT.05;DV0.05;DM.2;DN2;Dm50;Dn0.0001;Ff0;XQ40000;vv0;Dh;Hd;Pf;XD;', ("Noisy ampHiFail.  Should detect and switch amp current failure.", "Start looking at 'DOM 1' fig 3. Fault record (frozen). Will see 'diff' flashing on OLED even after fault cleared automatically (lost redundancy).", "ib_diff_fa will set red_loss but wait for wrap_fa to isolate and make selection change")),
          ...
          'tbFailMod': (72, 'Ca.5;Xp0;Xm247;DP1;W2;HR;Pf;vv4;Dh1000;Rs;Xv.002;Xu1;W4;Xu0;Xv1;W20;vv0;Pf;XQ60000;vv0;Dh;Hd;Pf;XD;', ("Run for 60 sec.   Plots DOM 1 Fig 2 or 3 should show Tb was detected as fault but not failed.",)),
          'tbFailHdwe': (72, 'Ca.5;Xp0;Xm246;DP1;W2;HR;Pf;vv4;Dh1000;Rs;Xv.002;W10;Xu1;W20;Xu0;Xv1;W20;vv0;Pf;XQ60000;vv0;Dh;Hd;Pf;XD;', ("Run for 60 sec.   Plots DOM 1 Fig 2 or 3 should show Tb was detected as fault but not failed.", "'Xp0' in reset puts Xm back to 247.")),
