...
lookup = {'init': ('Y;c;*W;*v0;*XS;*Ca0.5;<Rf;<Pf;', '', ('',), 0),
          ...
          'vHiFailH': ('Ff0;Xm247;Ca0.5;Dr100;DP1;HR;Pf;v2;W50;SH.3;W10;Dm0.001;Dv0.82;', ("Should detect voltage failure and display '*fail' and 'redl' within 60 seconds.", "To diagnose, begin with DOM 1 fig. 2 or 3.   Look for e_wrap to go through ewl_thr.", "You may have to increase magnitude of injection (Dv).  The threshold is 32 * r_ss.", "There MUST be no SATURATION.  Initial BB shift will be limited by hys table"), 30, 12),
